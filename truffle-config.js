 ...
 *
 * To deploy via Infura you'll need a wallet provider
 * (like @truffle/hdwallet-provider) to sign your transactions before they're
 * sent to a remote public node. Infura accounts are available for free at:
 * infura.io/register.
 *
...
const {API_KEY, projectId, mnemonic} = require("./secrets.json");
...
module.exports = {
  ...
  networks : {
    ...
    mumbai : {
      provider : () => new HDWalletProvider(
          mnemonic, `https://polygon-mumbai.g.alchemy.com/v2/${projectId}`),
      network_id : 80001,
      gas : 5500000,
      confirmations : 2,
      timeoutBlocks : 200,
  ...
  compilers : {
    solc : {
      version : "0.8.6", // Fetch exact version from solc-bin (default:
      // truffle's version)
      // docker: true,        // Use "0.5.1" you've installed locally with
      // docker (default: false)
      settings : {
        // See the solidity docs for advice about
